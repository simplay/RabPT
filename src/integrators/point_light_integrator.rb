...
class PointLightIntegrator
  ...
  # Basic Point Light integrator iterates over the light sources and
  # accumulates their BRDF contributions. Performs shading. No reflection,
  # refraction effects modeled No area light sources
  #
