...
class Reflective
  ...
  # computes outgoing mirror direction, reflected off at hit_position, relying
  # on incident light direction and the surface normal at that position.
  # theta_i denotes the angle between surface normal and incident light
  # direction.
  #
